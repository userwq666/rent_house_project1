...
CREATE TABLE IF NOT EXISTS messages (
    ...
    sender_principal_type VARCHAR(20) NULL COMMENT '发送主体类型：USER/OPERATOR/SYSTEM',
    sender_principal_id BIGINT NULL COMMENT '发送主体ID',
    receiver_principal_type VARCHAR(20) NULL COMMENT '接收主体类型：USER/OPERATOR/SYSTEM',
    receiver_principal_id BIGINT NULL COMMENT '接收主体ID',
    title VARCHAR(200),
    content TEXT,
    ...
    INDEX idx_msg_sender_principal (sender_principal_type, sender_principal_id),
    INDEX idx_msg_receiver_principal (receiver_principal_type, receiver_principal_id, status),
    INDEX idx_msg_conversation (sender_principal_type, sender_principal_id, receiver_principal_type, receiver_principal_id, created_at),
